      ...
      <div class="flex h-screen">
        <div class="flex-1 flex flex-col overflow-hidden">
          ...
          >
            ...
            <img
              v-if="selectedChar?.icon && selectedChar.icon !== '🧙'"
          ...
          <main class="flex-1 overflow-auto p-4 bg-[#121212]">
            <template v-if="selectedChar">
              <section v-if="current === 'Stats'"><Char /></section>
              <section v-else-if="current === 'Skills'"><Skills /></section>
              <section v-else-if="current === 'Roll'"><Rolls /></section>
              <section v-else-if="current === 'Inventory'"><Inventory /></section>
              <section v-else-if="current === 'Notes'"><Notes /></section>
            </template>
            <template v-else>
